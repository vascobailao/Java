package calc.core;
	...
	/**
   * Class Div, extends from FuncBin allowing access to methods and attributes
   * 
 	 *@author :		group 60
...
public class Div extends FuncBin{
	...
	public Div(Argumento arg1, Argumento arg2, String nomeFuncao){
		this.v1=arg1;
		this.v2=arg2;
